...
public class ProductController 
{
    ...
    @GetMapping("/product")
    public ResponseEntity <Page<Product>> findProductCategoryHandler(@RequestParam String category,
        ...
        // public ResponseEntity<List<Product>> searchProductHandler(@RequestParam String productName)
        // {
